...
def open_speech_page():
    ...
    welcome_msg = f"Hello Manikanta, let's convert your speech to text!"
    personalized_label = tk.Label(
        speech_window,
        text=welcome_msg,
        font=("Arial", 14),
        bg="#1E1E1E",
    ...
    message_label = tk.Label(
        speech_window,
        text="Click 'Start Listening' to speak",
        font=("Arial", 14),
        bg="#1E1E1E",
        fg="white"
    )
...
def start_page():
    start_window = tk.Tk()
    start_window.title("Welcome to Manikanta's Speech-to-Text")
    start_window.geometry("450x400")
    start_window.configure(bg="#1E1E1E")

    welcome_label = tk.Label(
        start_window,
        text="Welcome to Speech-to-Text Converter",
        font=("Arial", 18, "bold"),
        fg="#FFEB3B",
        bg="#1E1E1E"
    )
